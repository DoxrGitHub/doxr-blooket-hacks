...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/DoxrGitHub/doxr-blooket-hacks/main/autoupdate/timestamps/kingdom/choiceESPLoop.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1693429947509 || iframe.contentWindow.confirm(error)) cheat();
    }
