...
(() => {
    const cheat = (async () => {
        ...
        function GUI() {
            ...
            return React.createElement("div", {
                ...
                onClick: () => window.open("https://github.com/DoxrGitHub/doxr-blooket-hacks", "_blank").focus(),
                style: {
                    cursor: "pointer"
                },
                href: "https://github.com/DoxrGitHub/doxr-blooket-hacks"
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/DoxrGitHub/doxr-blooket-hacks/main/autoupdate/timestamps/reactGui.png?" + Date.now();
