...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/DoxrGitHub/doxr-blooket-hacks/main/autoupdate/timestamps/global/sellDuplicateBlooks.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1693429947422 || iframe.contentWindow.confirm(error)) cheat();
    }
